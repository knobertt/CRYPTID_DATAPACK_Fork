...
summon vindicator ~ 400 ~ {DeathLootTable:"minecraft:empty",CustomName:'[{"translate":"cryptid.entity.voracious_heart"}]',NoAI:1b,NoGravity:1b,PersistenceRequired:1b,Silent:1b,Tags:["cryptid","cryptid.vorheart","cryptid.underground",cryptid.heart],HandItems:[{Count:1}],ArmorItems:[{},{},{},{}],ArmorDropChances:[0f,0f,0f,0f],HandDropChances:[0f],attributes:[{id:"generic.max_health",base:96.3f},{id:"generic.armor",base:12f},{id:"generic.knockback_resistance",base:1f},{id:"generic.armor",base:0}]}
