...
execute if score @s cryptid.phase matches 1 run effect give @s minecraft:speed 2 1 true
#execute if score @s cryptid.phase matches 1 run if sco damage @s 0 player_attack by @p
...
execute if score @s cryptid.phase matches 2 run tp @s ^ ^ ^0.5 facing entity @p
...
execute if score @s cryptid.phase matches 2 if entity @p[distance=0..2,scores={cryptid.damagetaken=1..}] run scoreboard players set @s cryptid.handdamagetimer 160
execute if score @s cryptid.phase matches 2 if entity @p[distance=0..2,scores={cryptid.damagetaken=1..}] run scoreboard players set @s cryptid.phase 3
...
execute if score @s cryptid.phase matches 3 at @p positioned ^ ^ ^0.15 run tp @s ~ ~-0.6 ~0.05 facing entity @p
