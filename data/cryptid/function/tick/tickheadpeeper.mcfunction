...
execute rotated as @s if entity @s[tag=dig] at @s if block ~ ~5 ~ air run execute positioned ~ ~3 ~ positioned over motion_blocking_no_leaves run playsound block.stone.break ambient @a[distance=..20] ~ ~ ~ 3 0.6
...
execute rotated as @s if entity @s[tag=!dig] at @s unless block ~ ~-15 ~ air run execute positioned ~ ~3 ~ positioned over motion_blocking_no_leaves run playsound block.stone.break ambient @a[distance=..20] ~ ~ ~ 3 0.6
