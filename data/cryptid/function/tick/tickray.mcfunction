...
execute if score @s[tag=!duperay] cryptid.player.random matches 1..10 run summon minecraft:armor_stand ~2 ~-4 ~2 {Invisible:1, NoGravity:1, Tags:["duperay","cryptid","cryptid.skyray","cryptid.ignore.radar"],CustomName:'[{"translate":"cryptid.entity.ray_of_heaven"}]'}
