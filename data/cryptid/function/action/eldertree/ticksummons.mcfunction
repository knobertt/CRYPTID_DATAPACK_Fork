...
execute positioned over motion_blocking_no_leaves facing entity @e[sort=random,limit=1] eyes positioned ^ ^ ^10 positioned over motion_blocking_no_leaves run function cryptid:action/eldertree/spawnmob
