...
execute if score @s cryptid.player.random matches 20..24 if score .global cryptid.world.fury matches 1600.. run function cryptid:events/underground/spawndecimator
